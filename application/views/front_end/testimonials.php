            ...
            <div class="row">
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                  <div class="testimonial clearfix">
                     ...
                     <div class="testi-meta">
                        <img src="<?php echo base_url()?>assets/front_end/images/testi_01.png" alt="" class="img-responsive alignleft">
               ...
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                  <div class="testimonial clearfix">
                     ...
                     <div class="testi-meta">
                        <img src="<?php echo base_url()?>assets/front_end/images/testi_02.png" alt="" class="img-responsive alignleft">
            ...
            <div class="row">
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                  <div class="testimonial clearfix">
                     ...
                     <div class="testi-meta">
                        <img src="<?php echo base_url()?>assets/front_end/images/testi_03.png" alt="" class="img-responsive alignleft">
